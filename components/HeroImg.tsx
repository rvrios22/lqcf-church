  ...
  return (
    <div className="relative mx-auto my-6 flex w-4/5 justify-center overflow-clip rounded-2xl shadow-md">
      <img
        ...
        alt={`${name} header`}
      />
      <h1 className="absolute left-1/2 top-1/2 z-11 -translate-x-1/2 -translate-y-1/2 text-center font-[Inter,'Tahoma','Verdana',sans-serif] text-xl text-white [text-shadow:3px_2px_3px_rgb(0,0,0)] md:text-2xl lg:text-5xl">
        {text}
      </h1>
    </div>
  );
